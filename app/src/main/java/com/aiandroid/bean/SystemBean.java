...
public class SystemBean implements Parcelable {
    ...
    public static final Parcelable.Creator<SystemBean> CREATOR = new Parcelable.Creator<SystemBean>() {
        @Override
